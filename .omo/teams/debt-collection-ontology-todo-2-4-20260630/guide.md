...
- Team: **debt-collection-ontology** (id `ff3ad5ad-3caa-4826-affd-33701c54c2ea`)
- Team state: `/Users/cosmos/dev/ontology/trustgraph/.omo/teams/debt-collection-ontology-todo-2-4-20260630/team.json`
...
- **A** "ontology-config" (area) - resources/ontologies/recova-debt-collection.json plus scripts/legal_ontology/validate_ontology.py -> Implement Todo 2: TrustGraph-shaped recova-debt-collection ontology JSON and validator with happy/failure evidence. | thread title `[debt-collection-ontology] ontology-config` | thread 019f1739-c59e-7833-9da6-7de48bdb29d1 (codex://threads/019f1739-c59e-7833-9da6-7de48bdb29d1) | worktree /Users/cosmos/dev/ontology/trustgraph/.omo/teams/debt-collection-ontology-todo-2-4-20260630/worktrees/A [archived]
- **B** "ingest-loader" (area) - trustgraph_legal ingest package, CLI, registry dry-run tests, and PII-safe logging -> Implement Todo 4: OCR markdown zip dry-run ingest registry loader with hashes, duplicate detection, case_packet_id metadata, and evidence output. | thread title `[debt-collection-ontology] ingest-loader` | thread 019f1739-d390-7e00-88d2-21adf94f26ba (codex://threads/019f1739-d390-7e00-88d2-21adf94f26ba) [archived]
...
`/Users/cosmos/dev/ontology/trustgraph/.omo/teams/debt-collection-ontology-todo-2-4-20260630/artifacts`
...
- **A**: worktree `/Users/cosmos/dev/ontology/trustgraph/.omo/teams/debt-collection-ontology-todo-2-4-20260630/worktrees/A` on branch `team/debt-collection-ontology-todo-2-4-20260630/A`; thread codex://threads/019f1739-c59e-7833-9da6-7de48bdb29d1
- **B**: worktree `(assign with bind-thread --cwd)` on branch `team/debt-collection-ontology-todo-2-4-20260630/B`; thread codex://threads/019f1739-d390-7e00-88d2-21adf94f26ba
