...
- Team: **debt-collection-ontology** (id `debt-collection-ontology-todo-6-20260630`)
- Team state: `/Users/cosmos/dev/ontology/trustgraph/.omo/teams/debt-collection-ontology-todo-6-20260630/team.json`
...
- **A** "case-graph-builder" (area) - trustgraph_legal/case_graph.py and tests/unit/legal_ontology/test_case_graph_builder.py -> Implement Todo 6 hybrid case graph resolver with provenance, evidence keys, identity uncertainty, CLI, and focused tests. | thread title `[debt-collection-ontology] case-graph-builder` | thread 019f1791-5d5a-7f72-93c1-8f822e96eed1 (codex://threads/019f1791-5d5a-7f72-93c1-8f822e96eed1) [archived]
- **B** "case-graph-contract-review" (perspective) - Todo 6 acceptance risk audit and A branch review -> Review Todo 6 case graph contract, provenance, identity uncertainty, PII safety, and acceptance checks without editing production files. | thread title `[debt-collection-ontology] case-graph-contract-review` | thread 019f1791-88b3-7a53-8826-3ce0532d0bf7 (codex://threads/019f1791-88b3-7a53-8826-3ce0532d0bf7) [archived]
...
`/Users/cosmos/dev/ontology/trustgraph/.omo/teams/debt-collection-ontology-todo-6-20260630/artifacts`
...
- **A**: worktree `(assign with bind-thread --cwd)` on branch `team/debt-collection-ontology-todo-6-20260630/A`; thread codex://threads/019f1791-5d5a-7f72-93c1-8f822e96eed1
- **B**: worktree `(assign with bind-thread --cwd)` on branch `team/debt-collection-ontology-todo-6-20260630/B`; thread codex://threads/019f1791-88b3-7a53-8826-3ce0532d0bf7
