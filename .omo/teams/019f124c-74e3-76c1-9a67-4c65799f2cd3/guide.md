...
- Team: **debt-collection-ontology** (id `4595528a-1cd2-462c-8a6c-d271fa342f7c`)
- Team state: `/Users/cosmos/dev/ontology/trustgraph/.omo/teams/019f124c-74e3-76c1-9a67-4c65799f2cd3/team.json`
...
- **A** "domain-contract" (area) - docs/product/debt-collection-ontology/domain-contract.md and v0 legal domain boundary contract -> Create the v0 debt-collection ontology domain contract with document types, entity roles, fact categories, StopGate categories, confidence levels, PII handling, MCP scope groups, hybrid case identity, curated rule-source policy, and non-execution boundary. Include source-grounded rationale from plan/evidence without adding raw PII. | thread title `[debt-collection-ontology] domain-contract` | thread 019f1724-5918-7143-a531-74caf32f2713 (codex://threads/019f1724-5918-7143-a531-74caf32f2713) [archived]
- **B** "fixture-manifest" (area) - tests/fixtures/legal-ocr/manifest.json plus scripts/legal_ontology/check_fixture_manifest.py and minimized/redacted OCR fixture files -> Create a PII-safe representative fixture manifest and validator for Todo 1. Use only minimized/redacted or synthetic snippets from the OCR markdown corpus; no raw resident IDs, phone numbers, addresses, or account data. The manifest must validate with python3 -m json.tool and the custom check script; include failure-path evidence for missing document_type. | thread title `[debt-collection-ontology] fixture-manifest` | thread 019f1724-6bb7-77d3-970e-c45f1e121b07 (codex://threads/019f1724-6bb7-77d3-970e-c45f1e121b07) | worktree /Users/cosmos/dev/ontology/trustgraph/.omo/teams/019f124c-74e3-76c1-9a67-4c65799f2cd3/worktrees/B [archived]
...
`/Users/cosmos/dev/ontology/trustgraph/.omo/teams/019f124c-74e3-76c1-9a67-4c65799f2cd3/artifacts`
...
- **A**: worktree `(assign with bind-thread --cwd)` on branch `team/019f124c-74e3-76c1-9a67-4c65799f2cd3/A`; thread codex://threads/019f1724-5918-7143-a531-74caf32f2713
- **B**: worktree `/Users/cosmos/dev/ontology/trustgraph/.omo/teams/019f124c-74e3-76c1-9a67-4c65799f2cd3/worktrees/B` on branch `team/019f124c-74e3-76c1-9a67-4c65799f2cd3/B`; thread codex://threads/019f1724-6bb7-77d3-970e-c45f1e121b07
